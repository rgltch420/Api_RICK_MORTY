  ...
  return `
    <article class="card" data-id="${character.id}">
      ...
      <div class="card-actions">
        <button class="btn-edit" data-id="${character.id}" data-local="${isLocal}">Editar</button>
        <button class="btn-delete" data-id="${character.id}" data-local="${isLocal}">Eliminar</button>
      </div>
    </article>
  `;
}
